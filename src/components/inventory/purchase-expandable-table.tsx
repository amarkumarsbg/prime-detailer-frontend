      ...
      <table className="w-full min-w-[760px] text-sm">
        <thead>
          <tr className="border-b bg-muted/40 text-left text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">
            ...
            <th className="whitespace-nowrap px-3 py-2.5">Purchase #</th>
            ...
            return (
              <Fragment key={p.id}>
                <tr className="border-b border-border/60">
                  ...
                  <td className="whitespace-nowrap px-3 py-2.5 text-muted-foreground">{formatDate(p.purchasedAt)}</td>
                  ...
                  <td className="whitespace-nowrap px-3 py-2.5 text-right tabular-nums text-orange-700 dark:text-orange-400">
                    {formatCurrency(due)}
                  </td>
                  <td className="whitespace-nowrap px-3 py-2.5">
                    <span
